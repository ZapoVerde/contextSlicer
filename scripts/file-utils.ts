 /**
     ...
     * @description
     * This module provides a collection of generic, reusable helper functions for
     * interacting with the filesystem. Its functions that depend on a root path
     * now consume the `REPO_ROOT` constant, which correctly points to the user's
     * target project.
     * @api-declaration
     *   // (Auto-generated by audit script)
     * @contract
     *   assertions:
     *     purity: mutates # The functions in this file read from and write to the filesystem.
